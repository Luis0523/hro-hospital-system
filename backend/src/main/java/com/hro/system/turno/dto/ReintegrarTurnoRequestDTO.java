...
public class ReintegrarTurnoRequestDTO {
    ...
    @NotNull(message = "El ID del usuario (enfermería/médico) que autoriza la reintegración es obligatorio")
    @Schema(description = "ID del usuario que reintegra el turno", example = "3")
