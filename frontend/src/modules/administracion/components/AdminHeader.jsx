    ...
    <header className="sticky top-0 z-20 flex items-center justify-between gap-3 border-b border-slate-200 bg-white px-4 py-3 md:px-6">
      <div className="flex min-w-0 flex-1 items-center gap-3">
        <button
          ...
          className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg text-slate-600 transition hover:bg-slate-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-hro-blue md:hidden"
        >
        ...
        <div className="flex min-w-0 items-center gap-2">
          ...
          <div className="min-w-0 leading-tight">
            <h1
              className="truncate text-base font-bold text-hro-blue"
      ...
      <div className="flex min-w-0 items-center gap-3">
        <div className="min-w-0 text-right leading-tight">
          <p className="truncate text-sm font-semibold text-slate-700" title={usuario?.nombre}>
            {usuario?.nombre}
          </p>
          <p className="truncate text-xs uppercase text-slate-500" title={usuario?.rol}>
            {usuario?.rol}
          </p>
        </div>
